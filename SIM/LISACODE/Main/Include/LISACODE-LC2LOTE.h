...
#include "LISACODE-OrbitsOctaAnalytic.h"
#include "LISACODE-DataFileWrite.h"


/** \brief Class for managing the detector and the LOTE (LISA On Table Experiment).
 * \author A. Petiteau
 * \version 2.0
 * \date 12/07/2013
 *
 * This class provides a model that can be used by the LOTE (LISA On Table Experiment).
 * 
 *
 */
class LC2LOTE
